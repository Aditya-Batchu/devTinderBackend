...
requestRouter.post("/requset/send/:status/:toUserId", userAuth, async (req, res) => {
  try {
    ...
    if(existingConnectionRequest){
      res.json({messgae:"A Connection request is already made. You can only either accept or ignore"});
      return;
    }
